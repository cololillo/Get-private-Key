...
# Búsqueda en múltiples páginas de la primera a la última
def buscar_en_multiples_paginas(base_url, target_addresses, start_page, end_page):
    # Asegurarse de que start_page sea menor o igual que end_page para la búsqueda ascendente
    ...
    while page_number <= end_page and target_addresses:
        ...
        if found_address:
            ...
            if balance is not None:
                ...
                target_addresses.remove(found_address)  # Eliminar la dirección encontrada de target_addresses
        else:
    ...
    if not target_addresses:
        print("Se han encontrado todas las direcciones especificadas.")
    else:
        print("No se encontraron las siguientes direcciones:")
...
buscar_en_multiples_paginas(
    base_url,
    target_addresses,
    start_page=679297273601862223,
    end_page=1949680480282643005  # Ajusta este número según el rango de páginas que desees buscar
)
